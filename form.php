...
if (isset($_REQUEST['save'])) {
    ...
    $result = $user1->editApp($usercode, $usertype, $date, $projtitle, $princinvest, $coprincinvest1, $princinvestdept, $princinvestphone, $email, $deadline, $grant, $exemption, $numA, $numB, $numC, $numD, $numF, $numG
        ...
        if (isset($_FILES[$fileid])) {
            ...
            if (move_uploaded_file($tmp_name_array, "folder/" . $name_array)) {
               // echo $name_array[$i] . " upload is complete<br>";
                $user1->uploadFiles($name_array, $size_array, $type_array, $fileid, "folder/" . $name_array, 1);
            } else {

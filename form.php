 ...
 * Begin comment
=======
>>>>>>> b405c1f0999a78cd76b0dc43cc4104661d8ccdc4
...
, $risks, $conA, $conB, $conC1, $conC2, $conC3, $desc, $benf, $reas, $file1, $file2, $file3, $file4, $file5, $file6, $ids_array) {
    ...
    <html>
        ...
        <body>
            <table>
                <tr>
                    <td><a class="btn" colspan="2" href="logIn.php">LOGOUT</a></td>
                    <td colspan="2" id="page-header">
                        Request for Human Subjects Approval
                    </td>
                    <td><a class="btn" colspan="2" href="logIn.php">SAVE</a></td>
                </tr>
                <tr>
                    <td></td>
                    <td id="content">
                        ...
                        <div id="divContent">
                            ...
                            <form name="irbForm" method="POST" onsubmit="return formValidation()" enctype="multipart/form-data" >
                                ...
                                <fieldset>
                                    ...
                                    <div><b>Upload document: </b><input type="file" name="upload6" <?php
                                        if ($file6 == '') {
                                            echo "required";
                                        }
                                        ?>><b>Uploaded Document:<?php echo $file6 ?></b></div>
                                </fieldset>
                                <input type="submit" value="Save progress" name='save' formnovalidate>
                                <input type="submit" value="Submit For Review" name='submit' >
...
if (isset($_REQUEST['save'])) {
    ...
    $user1->addStatus($appid, $usercode);
    for ($x = 1; $x <= 6; $x++) {
        $fileid = "upload" . $x;
        // echo "$fileid";
        if (isset($_FILES[$fileid])) {
